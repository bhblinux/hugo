...
func fetch(url string) string {
	...
	req.Header.Set("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 YaBrowser/19.6.2.503 Yowser/2.5 Safari/537.36")
...
//开始解析
func parseUrls(url string, wg *sync.WaitGroup) {
	body := fetch(url)
...
func main() {
	...
	wg.Add(10)
	for i := 0; i < 10; i++ {
		go parseUrls("https://movie.douban.com/top250?start="+strconv.Itoa(25*i), &wg)
	}
	wg.Wait()
